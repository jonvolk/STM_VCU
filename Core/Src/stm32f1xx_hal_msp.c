...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA6     ------> ADC1_IN6
    */
    GPIO_InitStruct.Pin = LV_READ_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    HAL_GPIO_Init(LV_READ_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = THROTTLE_Pin|YAW_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA6     ------> ADC1_IN6
    */
    HAL_GPIO_DeInit(LV_READ_GPIO_Port, LV_READ_Pin);

    HAL_GPIO_DeInit(GPIOA, THROTTLE_Pin|YAW_Pin);
...
void HAL_TIM_OC_MspInit(TIM_HandleTypeDef* htim_oc)
{
  ...
  /* USER CODE END TIM5_MspInit 0 */
    ...
    __HAL_LINKDMA(htim_oc,hdma[TIM_DMA_ID_CC1],hdma_tim5_ch1);
